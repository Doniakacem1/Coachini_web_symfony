...
class ReviewClientController extends AbstractController
{
    ...
    /**
     * @Route("/allreviewsjson", name="allreviewsjson")
     */
    public function allreviews( NormalizerInterface $Normalizer )
    {
        $repository = $this->getDoctrine()->getRepository(ReviewClient::class);
        $reviews = $repository->findAll();

        $jsonContent = $Normalizer->normalize($reviews,'json',['groups'=>'post:read']);

        return new Response(json_encode($jsonContent));
    }

    /**
     * @Route("/reviewclientjsonid/{idReview}", name="reviewclientjsonID")
     */
    public function ReviewID( Request $request,$idReview,NormalizerInterface $Normalizer )
    {
        $em = $this->getDoctrine()->getManager();
        $review = $em->getRepository(ReviewClient::class)->find($idReview);
    ...
    /**
     * @Route("/addreviewclientid/new", name="addreviewclientjson")
     */
    public function addReview( Request $request,NormalizerInterface $Normalizer )
    {
        $em = $this->getDoctrine()->getManager();
        $review= new ReviewClient();
        $review->setDescriptionReview($request->get('descriptionReview'));
        $review->setNomClientReview($request->get('nomClientReview'));
        $review->setNomCoachReview($request->get('nomCoachReview'));
    ...
    /**
     * @Route("/updatereviewclientJSON/{idReview}", name="updatereviewclient")
     */
    public function updateReview( Request $request,$idReview,NormalizerInterface $Normalizer )
    {
        $em = $this->getDoctrine()->getManager();
        $review = $em->getRepository(ReviewClient::class)->find($idReview);
        ...
        return new Response("Review Updated !".json_encode($jsonContent));
    }
    /**
     * @Route("/deletereviewclientJSON/{idReview}", name="deletereviewclient")
     */
    public function deleteReviewjson( Request $request,$idReview,NormalizerInterface $Normalizer )
    {
        $em = $this->getDoctrine()->getManager();
        $review = $em->getRepository(ReviewClient::class)->find($idReview);
        ...
        return new Response("Review deleted !".json_encode($jsonContent));
    }
